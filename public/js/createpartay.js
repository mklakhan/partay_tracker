$(document).ready(() => {
  ...
  partayForm.on("submit", (event) => {
    ...
    if (
      !partayData.partay_name ||
      !partayData.partay_summary ||
      !partayData.partay_date ||
      !partayData.partay_time ||
      !partayData.partay_location ||
      !partayData.partay_image
    ) {
      return;
    }
